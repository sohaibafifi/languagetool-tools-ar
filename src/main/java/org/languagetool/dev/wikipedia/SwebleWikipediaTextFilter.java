...
public class SwebleWikipediaTextFilter {
  ...
  private final org.sweble.wikitext.engine.Compiler compiler;
  ...
  public SwebleWikipediaTextFilter() {
    try {
      config = new SimpleWikiConfiguration(
        "classpath:/org/languagetool/dev/SimpleWikiConfiguration.xml");
      compiler = new org.sweble.wikitext.engine.Compiler(config);
