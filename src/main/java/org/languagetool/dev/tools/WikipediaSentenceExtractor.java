...
class WikipediaSentenceExtractor {
  ...
  public static void main(String[] args) throws IOException, CompressorException {
    if (args.length != 2) {
      System.out.println("Usage: " + WikipediaSentenceExtractor.class.getSimpleName() + " <wikipediaXmlDump> <output>");
      System.exit(1);
    }
  ...
  private void extract(String xmlDumpPath, String outputFile) throws IOException, CompressorException {
